...
start=$(date +"%s")
get_build_message "Cloning devices stuff" "Cloning..."
...
start_end=$(($end - $start))
get_build_message "Cloning done" "device, kernel and vendor tree cloned! Task took $(($start_end / 60)) minutes, $(($start_end % 60)) seconds."
